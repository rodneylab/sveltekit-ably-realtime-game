...
<footer>
	<div class="footer-wrapper">
		<p class="notice">
			...
			>. Copyright {COPYRIGHT_ENTITY}&nbsp;2023&thinsp;&ndash;&thinsp;2026.
		</p>
			...
			<ul>
				<li>
					<a
						...
						target="_blank"
						href={`https://github.com/${githubPage}`}><GithubIcon /></a
					>
				</li>
				<li>
					<a
...
<style>
	.footer-wrapper {
		...
		margin: var(--spacing-4) var(--spacing-outer) var(--spacing-0);
